...
cardinal_million_tuples = [(tns_ptrn + "10" + thsnds_and_ptrn_cardinal + dec_ptrn_ordinal, '.*', 'ten thousands', ' tíu þúsund og'),
                            ...
                            (hndrds_ptrn_11 + "100" + thsnds_and_ptrn_cardinal + dec_ptrn, '.*', 'hundred thousands', ' eitt hundrað þúsund og'),
                            ("^100" + thsnds_and_ptrn_cardinal + dec_ptrn, '.*', 'hundred thousands', 'hundrað þúsund og'),
                            (hndrds_ptrn_11 + "100" + thsnds_and_ptrn_ordinal, '.*', 'hundred thousands', ' eitt hundrað þúsund og'),
                            ("^100" + thsnds_and_ptrn_ordinal, '.*', 'hundred thousands', 'hundrað þúsund og'),

                            (hndrds_ptrn_no11_def + "100" + thsnds_ptrn_after + dec_ptrn_ordinal, '.*', 'hundred thousands', ' eitt hundrað þúsund'),
                            ("^100" + thsnds_ptrn_after + dec_ptrn_ordinal, '.*', 'hundred thousands', 'hundrað þúsund'),
                            (hndrds_ptrn_11 + "1" + hndrd_and_thsnd + dec_ptrn_ordinal, '.*', 'hundred thousands', ' eitt hundrað og'),
                            ("^1" + hndrd_and_thsnd + dec_ptrn_ordinal, '.*', 'hundred thousands', ' hundrað og'),
                            (hndrds_ptrn_11 + "1" + hndrd_thsnd_after + dec_ptrn_ordinal, '.*', 'hundred thousands', ' eitt hundrað'),
...
for string, number in hundreds_thousands_zip:
    cardinal_million_tuples.append((hndrds_ptrn_no11 + number + "00" + thsnds_ptrn_after + dec_ptrn_ordinal, '.*', 'hundred thousands', string + ' hundruð þúsund'))
    cardinal_million_tuples.append((hndrds_ptrn_11 + number + "00" + thsnds_and_ptrn_cardinal + dec_ptrn, '.*', 'hundred thousands', string + ' hundruð þúsund og'))
    cardinal_million_tuples.append((hndrds_ptrn_11 + number + "00" + thsnds_and_ptrn_ordinal, '.*', 'hundred thousands', string + ' hundruð þúsund og'))
    cardinal_million_tuples.append((hndrds_ptrn_11 + number + hndrd_and_thsnd + dec_ptrn_ordinal, '.*', 'hundred thousands', string + ' hundruð og'))
    cardinal_million_tuples.append((hndrds_ptrn_11 + number + hndrd_thsnd_after + dec_ptrn_ordinal, '.*', 'hundred thousands', string + ' hundruð'))