from number_patterns import fraction_ptrn_before, half_ptrn
...
for rule, string in half_zip:
    fraction_tuples.append((half_ptrn, rule, 'points', ' og' + string))
    fraction_tuples.append((r"^(1\/2|½)$", rule, 'points', string))
    fraction_tuples.append((half_ptrn, rule, 'point2', ''))
    fraction_tuples.append((r"^(1\/2|½)$", rule, 'point2', ''))