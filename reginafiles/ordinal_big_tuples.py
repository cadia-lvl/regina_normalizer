...
for rule, letter in dozens_ordinal_letters:
    ...
    ordinal_big_tuples.append((hndrds_ptrn_11 + "100\.000\.0([01][1-9]|10)\.$", rule, 'hundred millions', ' eitt hundraðmilljón' + letter + ' og'))
    ordinal_big_tuples.append(("^100\.000\.0([01][1-9]|10)\.$", rule, 'hundred millions', 'hundraðmilljón' + letter + ' og'))
    ordinal_big_tuples.append((hndrds_ptrn_11 + "100(\.000){2}\.$", rule, 'hundred millions', ' eitt hundraðmilljón' + letter))
    ...
    ordinal_big_tuples.append((hndrds_ptrn_11 + "100(\.000){2}\.0([01][1-9]|10)\.$", rule, 'hundred billions', ' eitt hundraðmilljarð' + letter + ' og'))
    ...
    ordinal_big_tuples.append((hndrds_ptrn_11 + "100(\.000){3}\.$", rule, 'hundred billions', ' eitt hundraðmilljarð' + letter))
    ...
    for string, number in hundreds_thousands_zip:
        ordinal_big_tuples.append((hndrds_ptrn_11 + number + "00\.000\.0([01][1-9]|10)\.$", rule, 'hundred millions', string + ' hundruðmilljón' + letter + ' og'))
        ordinal_big_tuples.append((hndrds_ptrn_11 + number + "00(\.000){2}\.$", rule, 'hundred millions', string + ' hundruðmilljón' + letter))
        ordinal_big_tuples.append((hndrds_ptrn_11 + number + "00(\.000){2}\.0([01][1-9]|10)\.$", rule, 'hundred billions', string + ' hundruðmilljarð' + letter + ' og'))
        ordinal_big_tuples.append((hndrds_ptrn_11 + number + "00(\.000){3}\.$", rule, 'hundred billions', string + ' hundruðmilljarð' + letter))
