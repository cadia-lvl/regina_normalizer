...
cardinal_thousands_tuples = [(hndrds_ptrn_def + "1([01][1-9]|[1-9]0)" + dec_ptrn, '.*', 'hundreds', ' eitt hundrað og'),
                            (hndrds_ptrn_def + "1[2-9]0\.$", '.*', 'hundreds', ' eitt hundrað og'),
                            ("^1([01][1-9]|[1-9]0)" + dec_ptrn, '.*', 'hundreds', 'hundrað og'),
                            ("^1([2-9]0)\.$", '.*', 'hundreds', 'hundrað og'),
                            (hndrds_ptrn_def + "1([2-9][1-9]|00)" + dec_ptrn_ordinal, '.*', 'hundreds', ' eitt hundrað'),
...
for string, number in hundreds_thousands_zip:
    cardinal_thousands_tuples.append((hndrds_ptrn + number + "([01][1-9]|[1-9]0)" + dec_ptrn, '.*', 'hundreds', string + ' hundruð og'))
    cardinal_thousands_tuples.append((hndrds_ptrn + number + "[2-9]0\.$", '.*', 'hundreds', string + ' hundruð og'))
    cardinal_thousands_tuples.append((hndrds_ptrn + number + "00" + dec_ptrn, '.*', 'hundreds', string + ' hundruð'))
    cardinal_thousands_tuples.append((hndrds_ptrn + number + "[2-9][1-9]" + dec_ptrn_ordinal, '.*', 'hundreds', string + ' hundruð'))
