...
from number_patterns import tns_ptrn, hndrds_ptrn
...
for rule, letter in dozens_ordinal_letters:
    ...
    ordinal_million_tuples.append((hndrds_ptrn + "100\.?0([01][1-9]|10)\.$", rule, 'hundred thousands', ' eitt hundrað þúsund' + letter + ' og'))
    ordinal_million_tuples.append(("^100\.?0([01][1-9]|10)\.$", rule, 'hundred thousands', 'hundrað þúsund' + letter + ' og'))        
    ordinal_million_tuples.append((hndrds_ptrn + "100\.?000\.$", rule, 'hundred thousands',' eitt hundrað þúsund' + letter))
    ...
    for string, number in hundreds_thousands_zip:
        ordinal_million_tuples.append((hndrds_ptrn + number + "00\.?0([01][1-9]|10)\.$", rule, 'hundred thousands', string + ' hundruðþúsund' + letter + ' og'))
        ordinal_million_tuples.append((hndrds_ptrn + number + "00\.?000\.$", rule, 'hundred thousands',string + ' hundruðþúsund' + letter))
