...
cardinal_big_tuples = [(ones_ptrn_no11 + "1" + million_and_cardinal + dec_ptrn, '.*', 'millions', ' ein milljón og'),
                    ...
                    (hndrds_ptrn + "100" + million_and_cardinal + dec_ptrn, '.*', 'hundred millions', ' eitt hundrað milljónir og'),
                    (hndrds_ptrn + "100" + million_and_ordinal, '.*', 'hundred millions', ' eitt hundrað milljónir og'),
                    ...
                    (hndrds_ptrn + "100" + milln_ptrn_after + dec_ptrn_ordinal, '.*', 'hundred millions', ' eitt hundrað milljónir'),
                    ("^100" + milln_ptrn_after + dec_ptrn_ordinal, '.*', 'hundred millions', 'hundrað milljónir'),
                    (hndrds_ptrn + "1" + hndrd_and_million + dec_ptrn_ordinal, '.*', 'hundred millions', ' eitt hundrað og'),
                    ("^1" + hndrd_and_million + dec_ptrn_ordinal, '.*', 'hundred millions', 'hundrað og'),
                    (hndrds_ptrn + "1" + hndrd_million + dec_ptrn_ordinal, '.*', 'hundred millions', ' eitt hundrað'),
                    ...
                    (hndrds_ptrn + "100" + billion_and_cardinal + dec_ptrn, '.*', 'hundred billions', ' eitt hundrað milljarðar og'),
                    (hndrds_ptrn + "100" + billion_and_ordinal, '.*', 'hundred billions', ' eitt hundrað milljarðar og'),
                    ...
                    (hndrds_ptrn + "100" + billion_after + dec_ptrn_ordinal, '.*', 'hundred billions', ' eitt hundrað milljarðar'),
                    ("^100" + billion_after + dec_ptrn_ordinal, '.*', 'hundred billions', 'hundrað milljarðar'),

                    (hndrds_ptrn + "1" + hndrd_and_billion + dec_ptrn_ordinal, '.*', 'hundred millions', ' eitt hundrað og'),
                    ("^1" + hndrd_and_billion + dec_ptrn_ordinal, '.*', 'hundred billions', 'hundrað og'),
                    (hndrds_ptrn + "1" + hndrd_billion + dec_ptrn_ordinal, '.*', 'hundred billions', ' eitt hundrað'),
                    ("^1" + hndrd_billion + dec_ptrn_ordinal, '.*', 'hundred billions', 'hundrað')]


# CARDINAL
for string, number in hundreds_thousands_zip:
    cardinal_big_tuples.append((hndrds_ptrn + number + "00" + million_and_cardinal + dec_ptrn, '.*', 'hundred millions', string + ' hundruð milljónir og'))
    cardinal_big_tuples.append((hndrds_ptrn + number + "00" + million_and_ordinal, '.*', 'hundred millions', string + ' hundruð milljónir og'))
    cardinal_big_tuples.append((hndrds_ptrn + number + "00" + milln_ptrn_after + dec_ptrn_ordinal, '.*', 'hundred millions', string +  ' hundruð milljónir'))
    cardinal_big_tuples.append((hndrds_ptrn + number + hndrd_and_million + dec_ptrn_ordinal, '.*', 'hundred millions', string + ' hundruð og'))
    cardinal_big_tuples.append((hndrds_ptrn + number + hndrd_million + dec_ptrn_ordinal, '.*', 'hundred millions', string + ' hundruð'))

    cardinal_big_tuples.append((hndrds_ptrn + number + "00" + billion_and_cardinal + dec_ptrn, '.*', 'hundred billions', string + ' hundruð milljarðar og'))
    cardinal_big_tuples.append((hndrds_ptrn + number + "00" + billion_and_ordinal, '.*', 'hundred billions', string + ' hundruð milljarðar og'))
    cardinal_big_tuples.append((hndrds_ptrn + number + "00" + billion_after + dec_ptrn_ordinal, '.*', 'hundred billions', string + ' hundruð milljarðar'))
    cardinal_big_tuples.append((hndrds_ptrn + number + hndrd_and_billion + dec_ptrn_ordinal, '.*', 'hundred billions', string + ' hundruð og'))
    cardinal_big_tuples.append((hndrds_ptrn + number + hndrd_billion + dec_ptrn_ordinal, '.*', 'hundred billions', string + ' hundruð'))
